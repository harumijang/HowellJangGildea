...
const reviewsAllowedOnScreen = 4;
       ...
       <div class="d-flex">
        ...
        {reviews.map((r, index) => {
          ...
          if (index < reviewsAllowedOnScreen) {
            return (r.text.length<500 ? <div class="reviewSmall"><p >{r.text.substr(0,500)}</p></div>:  <Link to={
                    { 
                        pathname: '/review',
                        review: r
                    }
                      }>
            <div class="reviewSmall"><p >{r.text.substr(0,500)}........</p></div></Link>)     
          }
          if (index === reviewsAllowedOnScreen) {
